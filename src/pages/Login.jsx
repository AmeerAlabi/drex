        ...
        <form className="flex flex-col justify-between w-full mt-4" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-5 w-full">
            <div className="flex flex-col gap-2">
              <label htmlFor="username" className="text-[12.4px] font-medium text-gray-700">
                Username
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <div className="flex w-full items-center justify-between">
                <label htmlFor="password" className="text-[12.4px] font-medium text-gray-700">
                  Password
                </label>
          ...
          <div className="flex my-3 items-center gap-3">
            <input type="checkbox" id="keepLoggedIn" className='w-[15.94px] h-[15.94px]' />
            <label htmlFor="keepLoggedIn" className='text-gray-700 text-[12.4px] mt-1'>
              Keep me logged in
            </label>
          </div>

          <button type='submit' className="w-full bg-[#3855B3] h-[42.5px] rounded-[3.54px] hover:bg-opacity-50 text-white mt-6">
            Login
          </button>
        </form>
      </div>
