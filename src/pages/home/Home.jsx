      ...
      <section className='justify-center items-center'>
        <div className="p-2 mt-[25px]">
          ...
          <div className="flex flex-col lg:flex-row gap-[5px] mt-[25px] justify-center">
            <div className="bg-white border-2 rounded-lg border-[#d9d9d9] h-[260px] w-full lg:w-[350px] justify-center col-span-4 items-center p-4 lg:col-span-2">
            ...
            <div className="border-2 border-[#d9d9d9] rounded-lg h-[260px] w-full lg:w-[350px] col-span-4 p-3 lg:col-span-2">
          ...
          <div className="grid gap-3 mt-[25px] lg:grid-cols-4 justify-center">
            <div className="bg-white p-3 rounded-lg h-[60px] w-full flex justify-between col-span-4 lg:col-span-2 border-[1px]">
            ...
            <div className="bg-white p-3 rounded-lg h-[60px] w-full flex justify-between items-center col-span-4 lg:col-span-2 border-[1px]">
