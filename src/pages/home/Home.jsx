...
const Home = () => {
  ...
  <div className="grid gap-[7px] lg:grid-cols-4">
    ...
    <div className="h-[170px] w-[170px]  p-3 rounded-lg bg-[#FFF8E1] col-span-2 lg:col-span-1">
   ...
   <p className="  mt-[35px] ">35 min Ago  </p>
    ...
    <div className="h-[170px] w-[170px]  bg-[#E1F5FD] rounded-lg p-3 col-span-2 lg:col-span-1">
  ...
  <div className=" flex lg:flex-row flex-col gap-[7px] mt-[25px] p-3  justify-center">
    <div className=" bg-white border-2 rounded-lg    border-[#d9d9d9] h-[260px] w-[350px] lg:w-full   lg:ml-0 col-span-4  p-4 lg:col-span-2">
     ...
     <div className=' flex  bg-[#FF9365] p-1 mt-[3px]  items-center w-[300px] h-[105px] justify-around  rounded-lg  '>
        <div>
    ...
    <div className="border-2 border-[#d9d9d9] rounded-lg h-[260px] w-[350px] lg:w-full col-span-4 p-3 lg:col-span-2">
       <h1 className="font-bold mt-[3px]">Overall Progress </h1>
       <div  className= ' flex justify-between items-center ' >
        <h1 className=" font-semibold text-2xl mt-[8px] ">Germany for <br />begninners </h1>
        <img src={germany} alt="" />
       </div>
       <img src={progress} alt="" className=' justify- mt-[20px]  ' />
       <p className=' p-1 '>75%</p>
     
     <div className=' h-[1px] bg-[#d9d9d9] mt-[18px] w-[330px] '></div>
  ...
  <div className="grid gap-3 mt-[25px] lg:grid-cols-4 justify-center">
    <div className=" rounded-lg h-[60px] w-full  flex justify-between p-3 col-span-4 lg:col-span-2 border-[1px]">
        <div className='flex gap-[1px] items-center  '>
       <img src={writing} alt="" className=' w-[45px] h-[45px] ' />
       <p className="text-black font-semibold  "> Grammar  
       <br />
       <p className='  text-[12px] text-[#d9d9d9] '>+30 gamer rules</p>
       </p>
        </div>
        <img src={vector} alt="" className=' w-[13px] h-[13px]  mt-[12px] ' />
    </div>
    <div className="bg-white p-3 rounded-lg h-[60px] w-full col-span-4 lg:col-span-2 border-[1px] flex justify-between items-center">
